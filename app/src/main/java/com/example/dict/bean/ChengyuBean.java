...
public class ChengyuBean {
    ...
    public static class ResultBean {
         ...
         * head : 一
         * pinyin : yī xīn yī yì
         * chengyujs :  只有一个心眼儿，没有别的考虑。
         * from_ :  《三国志·魏志·杜恕传》：“免为庶人，徙章武郡，是岁嘉平元年。”裴松之注引《杜氏新书》：“故推一心，任一意，直而行之耳。”
         * example :  所以彭官保便～的料理防守事宜，庄制军便～料理军需器械。 清·张春帆《宦海》第四回
         * yufa :  联合式；作定语、状语；含褒义
         * ciyujs : [heart and soul;whole-heartedly] 形容专心专意,毫无他念
         * yinzhengjs : 《三国志·魏志·杜恕传》“免为庶人，徙 章武郡 ，是岁 嘉平 元年” 裴松之 注引《杜氏新书》：“故推一心，任一意，直而行之耳。”后因以“一心一意”谓同心同意；或专心专意，毫无他念。 唐 骆宾王 《代女道士王灵妃赠道士李荣》诗：“想知人意自相寻，果得深心共一心。一心一意无穷已，投漆投胶非足拟。” 明 王守仁 《传习录》卷上：“静而不妄动则安，安则一心一意只在此处，千思万想，务求必得此至善。”《儒林外史》第五二回：“ 陈正公 见他如此至诚，一心一意要把银子借与他。” 浩然 《艳阳天》第六章：“这时候的 马之悦 ，更是想尽一切办法，寻找一切机会，表现自己跟党一心一意。”
         * tongyi : ["全心全意","专心致志","聚精会神","全神贯注","真心实意","一心一意"]
         * fanyi : ["三心二意","见异思迁","心猿意马"]
         */
        ...
        public ResultBean(String chengyu, String bushou, String head, String pinyin, String chengyujs, String from_,
                          String example, String yufa, String ciyujs, String yinzhengjs, List<String> tongyi, List<String> fanyi) {
